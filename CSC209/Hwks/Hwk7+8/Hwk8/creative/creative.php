...
<head>
    ...
    <link id="page" rel="stylesheet" href="darkmode.css">
</head>

<body>
    
    <h1 style="text-align: center;">PHP Slideshow!</h1>
    <?php
        session_start();
...
<div class="sidenav">
    <div class="folder-selector">
        ...
        <a href="?folder=images4" class="folder-button">Flowers</a>
        <a href="?folder=images5" class="folder-button">Finals Season</a>
    </div>
</div>
    <div class="main">
    <div class="slideshow-container">
        ...
        <div class="dot-container">
            <?php
            for ($i = 0; $i < $NRIMAGES; $i++) {
                $activeClass = ($slideIndex == ($i + 1)) ? 'active' : ''; // Add active class for the current slide's dot
